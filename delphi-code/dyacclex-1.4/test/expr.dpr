...
// source: /usr/share/dyacclex/yyparse.cod line# 2
...
var
  ...
  procedure yyaction ( yyruleno : Integer );
    (* local definitions: *)
  // source: /usr/share/dyacclex/yyparse.cod line# 30
  begin
    (* actions: *)
    case yyruleno of
  1 : begin
  ...
  7 : begin
           ...
           writeln('LDC ', yyv[yysp-2].yyReal); writeln('LDC ', yyv[yysp-0].yyReal); writeln('SUB');
         end;
  8 : begin
  ...
  13 : begin
           // source: expr.y line#46
           yyval.yyReal := x[yyv[yysp-0].yyInteger];
         end;
  // source: /usr/share/dyacclex/yyparse.cod line# 34
    end;
  end(*yyaction*);
...
// source: /usr/share/dyacclex/yyparse.cod line# 39
