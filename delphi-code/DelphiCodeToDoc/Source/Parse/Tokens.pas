...
type
  TWordType = (wtNotAWord,
    ...
    wtIdentifier, wtOperator, wtTAGcomment); // TridenT
...
const
  ...
  // DCTD ADDED BY TRIDENT
  NotSolidTokensAndNotComment: TTokenTypeSet =
    [ttWhiteSpace, ttReturn, ttConditionalCompilationRemoved];
  NotSolidTokensOnLine: TTokenTypeSet = [ttWhiteSpace, ttComment];
  ...
  // TridenT
  ClassDefinitionDirectives: TTokenTypeSet = [ttSealed, ttAbstract, ttHelper];
...
type
  // DCTD MODIFIED BY TRIDENT
  TCommentStyle    = (eNotAComment, eDoubleSlash, eBracketStar, eCurlyBrace
    , eCompilerDirective, eUnknownTAG, eDescriptionTAG, eAuthorTAG, eVersionTAG
    , eTodoTAG, eParamTAG, eParameterIdentifier, eReturnTAG, eSeeTAG, eThrowsTAG
    , eAdditionalCommentTAG, eContentTAG, eStandard, eReturn);
  TCommentStyleSet = set of TCommentStyle;

const
  // DCTD MODIFIED BY TRIDENT
  CURLY_COMMENTS: TCommentStyleSet =
    [eCurlyBrace, eCompilerDirective, eUnknownTAG, eDescriptionTAG,
    eAuthorTAG, eVersionTAG, eTodoTAG, eParamTAG, eParameterIdentifier,
    eReturnTAG, eSeeTAG, eThrowsTAG,eReturn, eAdditionalCommentTAG];
  TAG_COMMENTS: TCommentStyleSet   =
    [eUnknownTAG, eDescriptionTAG, eAuthorTAG, eVersionTAG, eTodoTAG,
    eParamTAG, eReturnTAG, eSeeTAG, eThrowsTAG,eAdditionalCommentTAG];
  OPTIONAL_TAG_COMMENT: TCommentStyleSet = [eTodoTAG, eSeeTAG, eThrowsTAG, eAdditionalCommentTAG];
  CommentStyleName: array[low(TCommentStyle)..high(TCommentStyle)] of string =
    ('eNotAComment', 'eDoubleSlash', 'eBracketStar', 'eCurlyBrace'
    , 'eCompilerDirective', 'eUnknownTAG', 'eDescriptionTAG', 'eAuthorTAG'
    , 'eVersionTAG', 'eTodoTAG', 'eParamTAG', 'eParameterIdentifier'
    , 'eReturnTAG', 'eSeeTAG', 'eThrowsTAG','eAdditionalCommentTAG'
    ,'eContentTAG', 'eStandard','eReturn'
    );
