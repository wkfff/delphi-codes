...
const
  ...
  TAGNodes: TParseTreeNodeTypeSet =
    [nTAGAuthor, nTAGDescription, nTAGVersion, nTAGParam, nTAGReturn,
    nTAGSee, nTAGToDo, nTAGThrows, nTAGAdditionalComment, nTAGUnknown];
  
// TridenT - Added Records as Object type
  ObjectTypes: TParseTreeNodeTypeSet  = [nRecordType, nObjectType, nClassType, nInterfaceType];
  ObjectBodies: TParseTreeNodeTypeSet = [nClassBody, nInterfaceBody];
  ConstSections = [nConstSection, nResourcestringSection];

  { can declare these at the start of a procedure }
  InProcedureDeclSections: TParseTreeNodeTypeSet =
    [nVarSection, nConstSection, nResourcestringSection, nLabelDeclSection, nTypeSection];
  ...
  nTopLevelSections = [nTypeSection, nConstSection, nResourcestringSection, nVarSection,
