...
uses Forms; // for Application variable
...
begin
  ...
  FOutputFolder := ExtractFilePath(Application.ExeName)+'out\';
  ...
  FOutputFilteringCategory := [ocConstants, ocTypes, ocVariables
   , ocFunctions, ocClasses, ocFields, ocMethods, ocProperties, ocEvents];
