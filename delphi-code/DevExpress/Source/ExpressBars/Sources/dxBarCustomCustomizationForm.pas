...
uses
  ...
  cxClasses, dxMessages, dxBar, cxLookAndFeelPainters, cxLookAndFeels;
...
begin
  KillMessages(0, DXM_BAR_LB_DEFERREDCALLSYNCHRONIZATION);
...
begin
  PostMessage(Handle, DXM_BAR_LB_DEFERREDCALLSYNCHRONIZATION, Integer(AListBox), 0);
end;
    ...
    try
      ...
      begin
        ...
        begin
          ...
          SendMessage(AListBox.Handle, DXM_BAR_LB_SYNCHRONIZE, Integer(AChangedObject), AObjectIndex);
          if AListBox.MultiSelect then
...
begin
  ...
  ListBox.ItemHeight := ListBox.Canvas.TextHeight(dxMeasurePattern) + 2;
