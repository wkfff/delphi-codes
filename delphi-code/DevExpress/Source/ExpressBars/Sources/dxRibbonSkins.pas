...
type
  ...
  protected
    ...
    procedure LoadGalleryInRibbonScrollBarButtons(ABitmap: GpBitmap); virtual;
    procedure LoadGalleryInRibbonScrollBarButtonsGlyphs(ABitmap: GpBitmap); virtual;
  ...
  protected
    ...
    procedure LoadFormSkinFromBitmap(ABitmap: GpBitmap); override;
    procedure LoadGalleryInRibbonScrollBarButtonsGlyphs(ABitmap: GpBitmap); override;
...
procedure TdxCustomRibbonSkin.DrawQuickAccessToolbar(
  DC: HDC; const R: TRect; ABellow, ANonClientDraw: Boolean;
  AHasApplicationButton, AIsActive, ADontUseAero: Boolean);
...
function TdxCustomRibbonSkin.AdjustCaptionFontSize(
...
begin
  ...
  AddTwoStateElement(ABitmap, FBottomBorderThin,
    cxRectBounds(15, 50, 2, 2), cxEmptyRect, rfspActiveBottomBorderThin);
  AddTwoStateElement(ABitmap, FBottomBorderThick[False],
    cxRectBounds(40, 113, 10, 4), cxRect(4, 0, 4, 0), rfspActiveBottomBorderThick);
  AddTwoStateElement(ABitmap, FBottomBorderThick[True],
    cxRectBounds(40, 121, 10, 4), cxRect(4, 0, 4, 0), rfspActiveBottomBorderThickRectangular);
end;
...
begin
  ...
  LoadGalleryInRibbonScrollBarButtons(ABitmap);
  LoadGalleryInRibbonScrollBarButtonsGlyphs(ABitmap);
...
procedure TdxCustomRibbonTexturedSkin.LoadGalleryInRibbonScrollBarButtons(ABitmap: GpBitmap);
const
...
procedure TdxCustomRibbonTexturedSkin.LoadGalleryInRibbonScrollBarButtonsGlyphs(ABitmap: GpBitmap);
begin
...
begin
  ...
  //bottom border
  AddTwoStateElement(ABitmap, FBottomBorderThin,
    cxRectBounds(15, 23, 3, 1), cxEmptyRect, rfspActiveBottomBorderThin);
  AddTwoStateElement(ABitmap, FBottomBorderThick[False],
    cxRectBounds(15, 30, 16, 8), cxRect(7, 0, 7, 0), rfspActiveBottomBorderThick);
  AddTwoStateElement(ABitmap, FBottomBorderThick[True],
    cxRectBounds(15, 46, 16, 8), cxRect(7, 0, 7, 0), rfspActiveBottomBorderThickRectangular);
end;
...
procedure TdxCustomRibbon2010Skin.LoadGalleryInRibbonScrollBarButtonsGlyphs(ABitmap: GpBitmap);
begin
  LoadElementParts(ABitmap, FInRibbonGalleryScrollBarLineUpButtonGlyph,
