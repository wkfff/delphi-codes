...
uses
  ...
  dxCore, dxMessages, cxClasses, cxGraphics, cxControls, cxContainer, cxLookAndFeels, dxBar,
  dxBarSkin, dxFading, cxAccessibility, dxBarAccessibility, cxLookAndFeelPainters,
  dxRibbonSkins, dxRibbonFormCaptionHelper, dxRibbonForm, dxBarApplicationMenu;
...
type
  ...
  TdxRibbonTabsAreaButtonViewInfo = class;
  TdxRibbonTabsAreaButtonsViewInfo = class;
  ...
  public
    ...
    function GetApplicationButtonIconOffset: TRect; virtual;
    ...
    procedure DrawContextGroupsArea(ACanvas: TcxCanvas; const ABounds: TRect; AIsQATAtBottom: Boolean); virtual;
    ...
    procedure DrawGroupsArea(ACanvas: TcxCanvas; const ABounds: TRect;
      AIsAllowContextPaint: Boolean = True); virtual;
    ...
    procedure DrawHelpButtonGlyph(ACanvas: TcxCanvas; const ABounds: TRect;
      AState: TcxButtonState); virtual;
  ...
  TdxRibbonHitTest = (rhtNone, rhtTab, rhtApplicationMenu, rhtContext,
  ...
  TdxRibbonHitInfo = record
    ...
    Tab: TdxRibbonTab;
    Context: TdxRibbonContext;
    TabAreaButton: TdxRibbonTabsAreaButtonViewInfo;
  end;

  { TdxRibbonCustomViewInfoList }

  TdxRibbonCustomViewInfoList = class(TcxObjectList)
  private
  ...
  public
    ...
    function GetHitInfo(var AHitInfo: TdxRibbonHitInfo; X, Y: Integer): Boolean; virtual;
  ...
  TdxRibbonTabsViewInfo = class(TdxRibbonCustomViewInfoList)
  private
    FBitmap: TcxBitmap32;
  ...
  protected
    ...
    procedure UpdateCategorizedTabList;
  public
    constructor Create(AOwner: TdxRibbonViewInfo); override;
    destructor Destroy; override;
    procedure Calculate(const ABounds: TRect); override;
    function GetHitInfo(var AHitInfo: TdxRibbonHitInfo; X, Y: Integer): Boolean; override;
  ...
  { TdxRibbonTabsAreaButtonAccessibilityHelper }

  TdxRibbonTabsAreaButtonAccessibilityHelper = class(TdxBarAccessibilityHelper)
  private
    FButtonViewInfo: TdxRibbonTabsAreaButtonViewInfo;
    function GetRibbon: TdxCustomRibbon;
  protected
    ...
    property ButtonViewInfo: TdxRibbonTabsAreaButtonViewInfo read FButtonViewInfo;
    property Ribbon: TdxCustomRibbon read GetRibbon;
  public
    constructor CreateEx(AButtonViewInfo: TdxRibbonTabsAreaButtonViewInfo); virtual;
    function GetScreenBounds(AChildID: TcxAccessibleSimpleChildElementID): TRect; override;
  end;

  { TdxRibbonTabsAreaButtonViewInfo }

  TdxRibbonTabsAreaButtonViewInfo = class(TcxIUnknownObject, IdxFadingObject)
  protected
    FAccessibilityHelper: IdxBarAccessibilityHelper;
    FBounds: TRect;
    FFadingElementData: IdxFadingElementData;
    FOwner: TdxRibbonTabsAreaButtonsViewInfo;
  ...
  protected
    function CreateAccessibilityHelper: TdxRibbonTabsAreaButtonAccessibilityHelper; virtual;
    function GetHitTest: TdxRibbonHitTest; virtual;
  ...
  public
    constructor Create(AOwner: TdxRibbonTabsAreaButtonsViewInfo); virtual;
    destructor Destroy; override;
    ...
    property Owner: TdxRibbonTabsAreaButtonsViewInfo read FOwner;
    property Painter: TdxRibbonPainter read GetPainter;
    property Ribbon: TdxCustomRibbon read GetRibbon;
  ...
  { TdxRibbonTabsAreaMinimizeButtonViewInfo }

  TdxRibbonTabsAreaMinimizeButtonViewInfo = class(TdxRibbonTabsAreaButtonViewInfo)
  private
    function GetRibbon: TdxCustomRibbon;
  protected
    function GetHitTest: TdxRibbonHitTest; override;
  ...
  { TdxRibbonTabsAreaMDIButtonViewInfo }

  TdxRibbonTabsAreaMDIButtonViewInfo = class(TdxRibbonTabsAreaButtonViewInfo)
  protected
  ...
  { TdxRibbonTabsAreaHelpButtonViewInfo }

  TdxRibbonTabsAreaHelpButtonViewInfo = class(TdxRibbonTabsAreaButtonViewInfo)
  protected
    function GetHitTest: TdxRibbonHitTest; override;
    function GetIsEnabled: Boolean; override;
    procedure DrawButton(ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState); override;
  ...
  TdxRibbonTabsAreaButtonsViewInfo = class(TdxRibbonCustomViewInfoList)
  private
    FHotButton: TdxRibbonTabsAreaButtonViewInfo;
    FPressedButton: TdxRibbonTabsAreaButtonViewInfo;
    function GetItem(Index: Integer): TdxRibbonTabsAreaButtonViewInfo;
    function GetSelectedButton: TdxRibbonTabsAreaButtonViewInfo;
    procedure SetHotButton(AValue: TdxRibbonTabsAreaButtonViewInfo);
    procedure SetPressedButton(AValue: TdxRibbonTabsAreaButtonViewInfo);
  protected
    procedure CalculateButtonsBounds(var R: TRect);
  ...
  public
    ...
    function GetHitInfo(var AHitInfo: TdxRibbonHitInfo; X, Y: Integer): Boolean; override;
    //
    property HotButton: TdxRibbonTabsAreaButtonViewInfo read FHotButton write SetHotButton;
    property SelectedButton: TdxRibbonTabsAreaButtonViewInfo read GetSelectedButton;
    property Items[Index: Integer]: TdxRibbonTabsAreaButtonViewInfo read GetItem; default;
    property PressedButton: TdxRibbonTabsAreaButtonViewInfo read FPressedButton write SetPressedButton;
  end;
  ...
  TdxRibbonContextsViewInfo = class(TdxRibbonCustomViewInfoList)
  private
  ...
  TdxRibbonApplicationButtonViewInfo = class(TcxIUnknownObject, IdxFadingObject)
  private
    FBounds: TRect;
    FFadingElementData: IdxFadingElementData;
    FIsHot: Boolean;
    ...
    function GetFont: TFont;
    function GetIconBounds: TRect;
    function GetIsPaintOnGlass: Boolean;
    function GetIsPlacedOnTabsArea: Boolean;
    function GetPainter: TdxRibbonPainter;
    function GetState: TdxApplicationButtonState;
  ...
  protected
    ...
    procedure GetFadingParams(out AFadeOutImage: TcxBitmap;
      ...
      var AFadeInAnimationFrameDelay: Integer;
      var AFadeOutAnimationFrameCount: Integer;
  ...
  public
    ...
    property Font: TFont read GetFont;
    property IconBounds: TRect read GetIconBounds;
    property IsPaintOnGlass: Boolean read GetIsPaintOnGlass;
    property IsPlacedOnTabsArea: Boolean read GetIsPlacedOnTabsArea;
    property State: TdxApplicationButtonState read GetState;
  end;
  ...
  private
    ...
    FUseGlass: Boolean;
    function GetCanDrawDefaultFormIcon: Boolean;
    function GetCanvas: TcxCanvas;
    function GetColorScheme: TdxCustomRibbonSkin;
  ...
  protected
    ...
    function GetContextsRegion: HRGN; virtual;
    //QuickAccessToolbar
  ...
  public
    ...
    property Bounds: TRect read FBounds;
    property CanDrawDefaultFormIcon: Boolean read GetCanDrawDefaultFormIcon;
...
//  TdxRibbonQuickAccessBarControl = class(TdxBarPopupControl)
  ...
  protected
    ...
    property Unknown: IdxBarSelectableItem read FDesignSelectionHelper implements IUnknown;
  public
  ...
  private
    ...
    function GetIMenu: IdxRibbonApplicationMenu;
  ...
  protected
    ...
    property IMenu: IdxRibbonApplicationMenu read GetIMenu;
  public
    constructor Create(ARibbon: TdxCustomRibbon); virtual;
    destructor Destroy; override;
    procedure Assign(Source: TPersistent); override;
  ...
  public
    ...
    function GetApplicationButtonFont: TFont; virtual;
  ...
  TdxRibbonCustomPopupMenu = class(TdxBarPopupMenu)
  private
  ...
  private
    ...
    function GetTabsAreaButtonsViewInfo: TdxRibbonTabsAreaButtonsViewInfo;
    function GetViewInfo: TdxRibbonViewInfo;
  ...
  protected
    ...
    function IsApplicationMenuPopupFrameMode: Boolean;
    ...
    procedure ProcessTabOnMouseDown(const AHitInfo: TdxRibbonHitInfo; AButton: TMouseButton; AShift: TShiftState);
  ...
  public
    ...
    property TabsAreaButtonsViewInfo: TdxRibbonTabsAreaButtonsViewInfo read GetTabsAreaButtonsViewInfo;
    property ViewInfo: TdxRibbonViewInfo read GetViewInfo;
  end;
  ...
  private
    ...
    function GetRibbonPainter: TdxRibbonPainter;
  ...
  protected
    ...
    procedure DrawScrollButton(ACanvas: TcxCanvas; AButton: TdxRibbonScrollButton);
  public
    ...
    procedure Paint(ACanvas: TcxCanvas);
    //
    property RibbonPainter: TdxRibbonPainter read GetRibbonPainter;
  ...
  private
    ...
    procedure CMSelectAppMenuFirstItemControl(var Message: TMessage);
      message DXM_BAR_SELECTAPPMENUFIRSTITEMCONTROL;
  ...
  protected
    ...
    procedure DrawRibbonFormBorders(ACanvas: TcxCanvas;
      const AData: TdxRibbonFormData; const ABordersWidth: TRect);
    function GetIsApplicationMenuDropped: Boolean;
  ...
  {$ENDIF}
    ...
    // Accessibility
    property ApplicationButtonIAccessibilityHelper: IdxBarAccessibilityHelper read GetApplicationButtonIAccessibilityHelper;
  ...
  private
    ...
    function InternalGetChild(AIndex: Integer): IdxBarAccessibilityHelper;
    function InternalGetChildIndex(AChild: IdxBarAccessibilityHelper): Integer;
    function GetRibbon: TdxCustomRibbon;
    function GetTabsAreaButtonsViewInfo: TdxRibbonTabsAreaButtonsViewInfo;
  protected
    // IdxBarAccessibilityHelper
...
uses
  ...
  dxThemeConsts, dxThemeManager, dxGDIPlusAPI, dxHooks;
...
procedure dxRibbonMouseHook(ACode, WParam, LParam: Integer; var AHookResult: Integer);
var
...
begin
  ...
  case BarGetMouseWheelReceiver of
    ...
    mwrWindow:
      ...
      begin
        AReceiver.DoMouseWheel(InternalGetShiftState, ShortInt(HiWord(AMHS.mouseData)), cxInvalidPoint);
        AHookResult := 1;
      end
  end;
end;
...
begin
  ...
  if Assigned(ARibbon) and
    ARibbon.Visible and not ARibbon.Hidden and (ARibbon.ShowTabHeaders or ARibbon.ShowTabGroups) then
  begin
...
procedure TdxCustomDesignSelectionHelper.SelectComponent(
...
procedure TdxRibbonTabPainter.DrawText(ACanvas: TcxCanvas; const ABounds: TRect;
  const AText: string; AHasSeparator, AIsPaintOnGlass: Boolean);
const
  CustomFlags: array[Boolean] of Integer =
   (cxAlignBottom or cxSingleLine or cxAlignHCenter,
    cxAlignBottom or cxSingleLine or cxAlignLeft);
  GlassFlags: array[Boolean] of Integer =
   (DT_BOTTOM or DT_SINGLELINE or DT_CENTER,
    DT_BOTTOM or DT_SINGLELINE or DT_LEFT);
begin
  if AIsPaintOnGlass then
    dxDrawTextOnGlass(ACanvas.Handle, AText, ACanvas.Font, ABounds,
      ACanvas.Font.Color, GlassFlags[AHasSeparator], 0, True)
  else
  begin
...
procedure TdxRibbonPainter.DrawContextGroupsArea(
  ACanvas: TcxCanvas; const ABounds: TRect; AIsQATAtBottom: Boolean);
var
  B: TcxBitmap;
begin
  ...
  try
    ...
    ColorScheme.DrawContextTabGroupsArea(B.cxCanvas.Handle, B.ClientRect, AIsQATAtBottom);
...
begin
  ...
  if AIsAllowContextPaint and ViewInfo.HasActiveContextTab then
    DrawContextGroupsArea(ACanvas, ABounds, AIsQATAtBottom)
  else
    ColorScheme.DrawTabGroupsArea(ACanvas.Handle, ABounds, AIsQATAtBottom);
end;
...
procedure TdxRibbonPainter.DrawHelpButtonGlyph(
...
begin
  if IsFormZoomed and not IsWinSeven then
  begin
    ACanvas.Brush.Style := bsClear;
...
begin
  ...
  begin
    ColorScheme.DrawFormCaption(ACanvas.Handle,
      ABounds, AData, Ribbon.ShowTabHeaders and not Ribbon.Hidden);
  end;
  if Ribbon.Hidden or (AData.State = wsMinimized) then
  ...
  begin
    ...
    if ViewInfo.ApplicationButtonViewInfo.IsVisible then
      ViewInfo.ApplicationButtonViewInfo.Paint(ACanvas);
...
begin
  ...
  try
    ...
    Dec(R.Right, Ribbon.GetWindowBordersWidth.Right);
    Inc(R.Left, Ribbon.GetWindowBordersWidth.Left);
...
begin
  ColorScheme.DrawFormBordersEx(ACanvas.Handle, ABordersWidth,
    Ribbon.GetRibbonFormCaptionHeight, Ribbon.GetRibbonFormCaptionAreaExtention,
    AData, Ribbon.HasStatusBar);
end;
...
function TdxRibbonPainter.GetApplicationButtonIconOffset: TRect;
begin
  Result := ColorScheme.GetPartContentOffsets(DXBAR_APPLICATIONBUTTONICONOFFSET);
  Result.Bottom := cxGetValueCurrentDPI(Result.Bottom);
  Result.Top := cxGetValueCurrentDPI(Result.Top);
  Result.Right := cxGetValueCurrentDPI(Result.Right);
  Result.Left := cxGetValueCurrentDPI(Result.Left);
end;

function TdxRibbonPainter.GetApplicationButtonOffset: TRect;
begin
  Result := ColorScheme.GetPartContentOffsets(DXBAR_APPLICATIONBUTTON);
end;

function TdxRibbonPainter.GetApplicationButtonSize: TSize;
begin
  Result := ColorScheme.GetApplicationMenuGlyphSize;
  Result.cx := cxGetValueCurrentDPI(Result.cx);
  Result.cy := cxGetValueCurrentDPI(Result.cy);
end;
...
begin
  inherited Create;
  FTab := ATab;
  FPainter := GetPainterClass.Create(Ribbon.ColorScheme);
end;
...
begin
  Result := Ribbon.ColorScheme.GetPartOffset(rspContextTabSeparatorBegin);
end;

function TdxRibbonTabViewInfo.GetIsTabActive: Boolean;
begin
  Result := Tab.Active and Ribbon.AreGroupsVisible and
    not Ribbon.Controller.IsApplicationMenuPopupFrameMode;
end;
...
begin
  Result := cxRect(Bounds.Right - dxRibbonTabSeparatorWidth,
    Bounds.Top, Bounds.Right, Bounds.Bottom - 1);
end;
...
begin
  Result := Ribbon.Fonts.GetTabHeaderFont(GetTabState, Tab.Context <> nil);
end;
...
begin
  ...
  DrawScrollButtons(Bitmap.cxCanvas);
  for I := 0 to Count - 1 do
...
procedure TdxRibbonTabsViewInfo.DrawScrollButtons(ACanvas: TcxCanvas);
var
  AButton: TdxRibbonScrollButton;
begin
  for AButton := Low(AButton) to High(AButton) do
...
begin
  ...
  if Owner.Owner.Style = rs2010 then
  begin
...
procedure TdxRibbonContextViewInfo.DrawText(ACanvas: TcxCanvas);
  ...
  procedure DoDrawText(const R: TRect; ATextColor: TColor);
  begin
    if ATextColor <> clNone then
    begin
      ACanvas.Font.Color := ATextColor;
      ACanvas.DrawText(Text, R, cxShowEndEllipsis or
        cxAlignHCenter or cxAlignVCenter or cxSingleLine);
    end;
  end;
...
begin
  ...
  if IsPaintOnGlass then
  begin
    Painter.DrawGlowingText(ACanvas.Handle, Text, Font, TextBounds, Font.Color,
      DT_CENTER or DT_SINGLELINE or DT_END_ELLIPSIS or DT_VCENTER or DT_NOPREFIX, True);
  end
  else
  begin
    ACanvas.Font := Font;
    ACanvas.Brush.Style := bsClear;
    DoDrawText(cxRectOffset(TextBounds, 1, 1), FontShadowColor);
    DoDrawText(TextBounds, Font.Color);
    ACanvas.Brush.Style := bsSolid;
  end;
  if ANeedClipping then
    ACanvas.RestoreClipRegion;
...
begin
  ...
  begin
    Canvas.Font := Font;
    if IsPaintOnGlass then
      Result := CalculateTextBounds(Canvas.Handle, dxCaptionGlowRadius)
    else
      Result := CalculateTextBounds(Canvas.Handle, dxRibbonTabsLeftSpace);
...
begin
  Result := Owner.Owner.ColorScheme.GetPartColor(rspContextTextShadow);
end;
...
constructor TdxRibbonCustomViewInfoList.Create(AOwner: TdxRibbonViewInfo);
begin
  inherited Create;
  FOwner := AOwner;
end;

procedure TdxRibbonCustomViewInfoList.Calculate(const ABounds: TRect);
begin
  FBounds := ABounds;
end;

procedure TdxRibbonCustomViewInfoList.Invalidate;
begin
  InvalidateRect(Bounds);
end;

procedure TdxRibbonCustomViewInfoList.InvalidateRect(const R: TRect);
begin
  Owner.Ribbon.InvalidateRect(R, False);
end;

function TdxRibbonCustomViewInfoList.GetHitInfo(
  var AHitInfo: TdxRibbonHitInfo; X, Y: Integer): Boolean;
begin
  Result := False;
end;
...
constructor TdxRibbonTabsAreaButtonAccessibilityHelper.CreateEx(
  AButtonViewInfo: TdxRibbonTabsAreaButtonViewInfo);
begin
  Create(AButtonViewInfo.Ribbon);
  FButtonViewInfo := AButtonViewInfo;
end;

function TdxRibbonTabsAreaButtonAccessibilityHelper.GetBarManager: TdxBarManager;
begin
  Result := Ribbon.BarManager;
end;

function TdxRibbonTabsAreaButtonAccessibilityHelper.GetNextAccessibleObject(
  ADirection: TcxAccessibilityNavigationDirection): IdxBarAccessibilityHelper;
begin
  Result := nil;
  case ADirection of
...
function TdxRibbonTabsAreaButtonAccessibilityHelper.HandleNavigationKey(var AKey: Word): Boolean;
begin
...
function TdxRibbonTabsAreaButtonAccessibilityHelper.IsNavigationKey(AKey: Word): Boolean;
begin
  Result := inherited IsNavigationKey(AKey) or (AKey in [VK_ESCAPE, VK_SPACE, VK_RETURN]);
end;

procedure TdxRibbonTabsAreaButtonAccessibilityHelper.Select(ASetFocus: Boolean);
begin
  inherited Select(ASetFocus);
  ButtonViewInfo.Invalidate;
end;

procedure TdxRibbonTabsAreaButtonAccessibilityHelper.Unselect(
...
function TdxRibbonTabsAreaButtonAccessibilityHelper.GetAssignedKeyTip: string;
begin
  Result := '';
end;

function TdxRibbonTabsAreaButtonAccessibilityHelper.GetDefaultKeyTip: string;
begin
  Result := '';
end;

function TdxRibbonTabsAreaButtonAccessibilityHelper.GetOwnerObjectWindow: HWND;
begin
  Result := Parent.OwnerObjectWindow;
end;

function TdxRibbonTabsAreaButtonAccessibilityHelper.GetParent: TcxAccessibilityHelper;
begin
  Result := Ribbon.IAccessibilityHelper.GetHelper;
end;

function TdxRibbonTabsAreaButtonAccessibilityHelper.GetScreenBounds(
...
function TdxRibbonTabsAreaButtonAccessibilityHelper.GetSelectable: Boolean;
begin
  Result := Visible;
end;

function TdxRibbonTabsAreaButtonAccessibilityHelper.GetState(
  AChildID: TcxAccessibleSimpleChildElementID): Integer;
begin
  Result := Parent.States[cxAccessibleObjectSelfID];
end;

function TdxRibbonTabsAreaButtonAccessibilityHelper.GetRibbon: TdxCustomRibbon;
begin
...
constructor TdxRibbonTabsAreaButtonViewInfo.Create(
  AOwner: TdxRibbonTabsAreaButtonsViewInfo);
begin
  inherited Create;
  FState := cxbsNormal;
  FOwner := AOwner;
...
destructor TdxRibbonTabsAreaButtonViewInfo.Destroy;
begin
  if Fader <> nil then
    Fader.Remove(Self);
...
function TdxRibbonTabsAreaButtonViewInfo.CanFade: Boolean;
begin
  Result := Assigned(Ribbon) and Ribbon.CanFade;
end;

procedure TdxRibbonTabsAreaButtonViewInfo.CalculateState;
begin
  if not Enabled then
    State := cxbsDisabled
  else
    if Owner.PressedButton = Self then
      State := cxbsPressed
    else
      if Owner.HotButton = Self then
        State := cxbsHot
      else
        State := cxbsNormal;
end;

procedure TdxRibbonTabsAreaButtonViewInfo.Click;
begin
end;

function TdxRibbonTabsAreaButtonViewInfo.CreateAccessibilityHelper: TdxRibbonTabsAreaButtonAccessibilityHelper;
begin
  Result := TdxRibbonTabsAreaButtonAccessibilityHelper.CreateEx(Self);
end;

function TdxRibbonTabsAreaButtonViewInfo.GetHitTest: TdxRibbonHitTest;
begin
  Result := rhtNone;
end;

function TdxRibbonTabsAreaButtonViewInfo.GetIsEnabled: Boolean;
begin
  Result := not Ribbon.Controller.IsApplicationMenuPopupFrameMode
end;

procedure TdxRibbonTabsAreaButtonViewInfo.Draw(ACanvas: TcxCanvas);
begin
  if Assigned(FFadingElementData) then
    FFadingElementData.DrawImage(ACanvas.Handle, Bounds)
  else
    DrawButton(ACanvas, Bounds, State);
  DrawButtonGlyph(ACanvas, Bounds, State);
end;

procedure TdxRibbonTabsAreaButtonViewInfo.DrawButton(
  ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState);
begin
end;

procedure TdxRibbonTabsAreaButtonViewInfo.DrawButtonGlyph(
  ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState);
begin
end;

procedure TdxRibbonTabsAreaButtonViewInfo.DrawFadeImage;
begin
  Invalidate;
end;

procedure TdxRibbonTabsAreaButtonViewInfo.FadingBegin(AData: IdxFadingElementData);
begin
  FFadingElementData := AData;
end;

procedure TdxRibbonTabsAreaButtonViewInfo.FadingEnd;
begin
  FFadingElementData := nil;
end;

procedure TdxRibbonTabsAreaButtonViewInfo.Invalidate;
begin
  Ribbon.InvalidateRect(Bounds, False);
end;

function TdxRibbonTabsAreaButtonViewInfo.GetAccessibilityHelper: IdxBarAccessibilityHelper;
begin
...
function TdxRibbonTabsAreaButtonViewInfo.GetFader: TdxFader;
begin
  Result := Ribbon.Fader;
end;

procedure TdxRibbonTabsAreaButtonViewInfo.GetFadingParams(
  out AFadeOutImage, AFadeInImage: TcxBitmap;
  var AFadeInAnimationFrameCount, AFadeInAnimationFrameDelay: Integer;
  var AFadeOutAnimationFrameCount, AFadeOutAnimationFrameDelay: Integer);
begin
...
function TdxRibbonTabsAreaButtonViewInfo.GetHitInfo(
  var AHitInfo: TdxRibbonHitInfo; X, Y: Integer): Boolean;
begin
  Result := cxRectPtIn(Bounds, X, Y);
  if Result then
  begin
    AHitInfo.HitTest := GetHitTest;
    AHitInfo.TabAreaButton := Self;
  end;
end;

function TdxRibbonTabsAreaButtonViewInfo.GetPainter: TdxRibbonPainter;
begin
  Result := ViewInfo.Painter;
end;

function TdxRibbonTabsAreaButtonViewInfo.GetRibbon: TdxCustomRibbon;
begin
  Result := ViewInfo.Ribbon;
end;

function TdxRibbonTabsAreaButtonViewInfo.GetState: TcxButtonState;
begin
  Result := FState;
...
function TdxRibbonTabsAreaButtonViewInfo.GetViewInfo: TdxRibbonViewInfo;
begin
  Result := Owner.Owner;
end;

procedure TdxRibbonTabsAreaButtonViewInfo.SetState(AValue: TcxButtonState);
begin
...
procedure TdxRibbonTabsAreaMinimizeButtonViewInfo.Click;
begin
  if Enabled then
    Ribbon.ShowTabGroups := not Ribbon.ShowTabGroups;
end;

procedure TdxRibbonTabsAreaMinimizeButtonViewInfo.DrawButton(
  ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState);
begin
  Painter.DrawMinimizeButton(ACanvas, R, AState, not Ribbon.ShowTabGroups);
end;

procedure TdxRibbonTabsAreaMinimizeButtonViewInfo.DrawButtonGlyph(
  ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState);

  function GetGlyph: TdxRibbonMinimizeButtonGlyph;
  begin
...
begin
  Painter.DrawMinimizeButtonGlyph(ACanvas, R, AState, GetGlyph);
end;

function TdxRibbonTabsAreaMinimizeButtonViewInfo.GetHitTest: TdxRibbonHitTest;
begin
  Result := rhtMinimizeButton;
end;

function TdxRibbonTabsAreaMinimizeButtonViewInfo.GetRibbon: TdxCustomRibbon;
begin
...
procedure TdxRibbonTabsAreaMDIButtonViewInfo.DrawButton(
  ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState);
begin
  Painter.DrawMDIButton(ACanvas, R, ButtonType, AState);
end;

procedure TdxRibbonTabsAreaMDIButtonViewInfo.DrawButtonGlyph(
  ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState);
begin
  Painter.DrawMDIButtonGlyph(ACanvas, R, ButtonType, AState);
end;

procedure TdxRibbonTabsAreaMDIButtonViewInfo.Click;
begin
  if Ribbon.IsBarManagerValid and Enabled then
    Ribbon.BarManager.DoMDIButtonCommand(ButtonType);
end;

function TdxRibbonTabsAreaMDIButtonViewInfo.GetHitTest: TdxRibbonHitTest;
const
  MDIButtonToHitTest: array[TdxBarMDIButton] of TdxRibbonHitTest =
    (rhtMDIMinimizeButton, rhtMDIRestoreButton, rhtMDICloseButton);
begin
  Result := MDIButtonToHitTest[ButtonType];
end;

function TdxRibbonTabsAreaMDIButtonViewInfo.GetIsEnabled: Boolean;
begin
...
procedure TdxRibbonTabsAreaHelpButtonViewInfo.Click;
begin
  Ribbon.DoHelpButtonClick;
end;

procedure TdxRibbonTabsAreaHelpButtonViewInfo.DrawButton(
  ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState);
begin
  Painter.DrawHelpButton(ACanvas, R, AState);
end;

procedure TdxRibbonTabsAreaHelpButtonViewInfo.DrawButtonGlyph(
  ACanvas: TcxCanvas; const R: TRect; AState: TcxButtonState);
begin
  Painter.DrawHelpButtonGlyph(ACanvas, R, AState);
end;

function TdxRibbonTabsAreaHelpButtonViewInfo.GetHitTest: TdxRibbonHitTest;
begin
  Result := rhtHelpButton;
end;

function TdxRibbonTabsAreaHelpButtonViewInfo.GetIsEnabled: Boolean;
begin
  Result := True;
end;
...
procedure TdxRibbonTabsAreaButtonsViewInfo.Calculate(const ABounds: TRect);
begin
  RecreateViewInfos;
  FBounds := cxRectSetRight(ABounds, ABounds.Right, 0);
  CalculateButtonsBounds(FBounds);
  CalculateButtonsStates;
end;

procedure TdxRibbonTabsAreaButtonsViewInfo.CalculateButtonsBounds(var R: TRect);
var
  I: Integer;
begin
...
procedure TdxRibbonTabsAreaButtonsViewInfo.CalculateButtonsStates;
var
  I: Integer;
begin
  for I := Count - 1 downto 0 do
...
procedure TdxRibbonTabsAreaButtonsViewInfo.RecreateViewInfos;
var
  AButton: TdxBarMDIButton;
  AButtonViewInfo: TdxRibbonTabsAreaMDIButtonViewInfo;
begin
  Clear;
  if Owner.Style = rs2010 then
    Add(TdxRibbonTabsAreaMinimizeButtonViewInfo.Create(Self));
  if Owner.HasHelpButton then
    Add(TdxRibbonTabsAreaHelpButtonViewInfo.Create(Self));
  if Owner.HasMDIButtons then
  begin
    for AButton := Low(AButton) to High(AButton) do
    begin
      AButtonViewInfo := TdxRibbonTabsAreaMDIButtonViewInfo.Create(Self);
...
function TdxRibbonTabsAreaButtonsViewInfo.GetItem(Index: Integer): TdxRibbonTabsAreaButtonViewInfo;
begin
  Result := TdxRibbonTabsAreaButtonViewInfo(inherited Items[Index]);
end;

function TdxRibbonTabsAreaButtonsViewInfo.GetSelectedButton: TdxRibbonTabsAreaButtonViewInfo;
var
  I: Integer;
begin
  Result := nil;
...
function TdxRibbonTabsAreaButtonsViewInfo.GetHitInfo(
  var AHitInfo: TdxRibbonHitInfo; X, Y: Integer): Boolean;
var
  I: Integer;
begin
  ...
  for I := 0 to Count - 1 do
  begin
    Result := Items[I].GetHitInfo(AHitInfo, X, Y);
    if Result then
      Break;
  end;
end;

procedure TdxRibbonTabsAreaButtonsViewInfo.SetHotButton(
  AValue: TdxRibbonTabsAreaButtonViewInfo);
begin
...
procedure TdxRibbonTabsAreaButtonsViewInfo.SetPressedButton(
  AValue: TdxRibbonTabsAreaButtonViewInfo);
begin
...
constructor TdxRibbonApplicationButtonViewInfo.Create(ARibbon: TdxCustomRibbon);
begin
  inherited Create;
  FRibbon := ARibbon;
end;
...
begin
  ...
  begin
    ...
    with Painter.GetApplicationButtonOffset do
    begin
      Inc(FBounds.Right, Left + Right);
      Inc(FBounds.Bottom, Top + Bottom);
    end;
    if IsPlacedOnTabsArea then
      FBounds := cxRectSetWidth(Ribbon.ViewInfo.GetTabsAreaBounds, cxRectWidth(Bounds));
  end
  else
    FBounds := cxNullRect;
end;
...
begin
  Result := Painter.GetApplicationButtonSize;
  if CanShowApplicationButtonText then
  begin
    Result.cx := Max(Result.cx, cxTextWidth(Font, ApplicationButton.Text) +
      cxMarginsWidth(Painter.GetApplicationButtonIconOffset));
  end;
end;
...
procedure TdxRibbonApplicationButtonViewInfo.FadingBegin(AData: IdxFadingElementData);
begin
  FFadingElementData := AData;
end;

procedure TdxRibbonApplicationButtonViewInfo.FadingEnd;
begin
  FFadingElementData := nil;
end;

procedure TdxRibbonApplicationButtonViewInfo.GetFadingParams(
  out AFadeOutImage, AFadeInImage: TcxBitmap;
  var AFadeInAnimationFrameCount, AFadeInAnimationFrameDelay: Integer;
  var AFadeOutAnimationFrameCount, AFadeOutAnimationFrameDelay: Integer);
begin
  ...
  Painter.DrawApplicationButton(AFadeInImage.cxCanvas, AFadeInImage.ClientRect, absHot);
  Painter.DrawApplicationButton(AFadeOutImage.cxCanvas, AFadeOutImage.ClientRect, absNormal);
end;
...
begin
  if FFadingElementData = nil then
    ...
    FFadingElementData.DrawImage(ACanvas.Handle, ClientBounds);
end;
...
begin
  Painter.DrawApplicationButtonGlyph(ACanvas, IconBounds, ApplicationButton.Glyph);
end;
...
procedure TdxRibbonApplicationButtonViewInfo.Invalidate;
begin
  if IsVisible and not Ribbon.IsDestroying then
  begin
    Ribbon.InvalidateRect(ClientBounds, False);
    if Ribbon.Style = rs2010 then
...
procedure TdxRibbonApplicationButtonViewInfo.Paint(ACanvas: TcxCanvas);
begin
...
function TdxRibbonApplicationButtonViewInfo.GetHitInfo(
  var AHitInfo: TdxRibbonHitInfo; X, Y: Integer): Boolean;
begin
  Result := IsVisible and cxRectPtIn(ClientBounds, X, Y);
  if Result then
...
begin
  Result := cxRectContent(Bounds, Painter.GetApplicationButtonOffset);
end;

function TdxRibbonApplicationButtonViewInfo.GetFont: TFont;
begin
  Result := Ribbon.Fonts.GetApplicationButtonFont;
end;

function TdxRibbonApplicationButtonViewInfo.GetIconBounds: TRect;
var
  AIconSize: TSize;
begin
  ...
  Result := cxRectContent(ClientBounds, Painter.GetApplicationButtonIconOffset);
  if ApplicationButton.StretchGlyph then
  begin
    with cxRectProportionalStretch(Result, AIconSize.cx, AIconSize.cy) do
      AIconSize := cxSize(Right - Left, Bottom - Top);
  end;
...
function TdxRibbonApplicationButtonViewInfo.GetState: TdxApplicationButtonState;
begin
...
begin
  ...
  FApplicationButtonViewInfo := TdxRibbonApplicationButtonViewInfo.Create(ARibbon);
...
begin
  ...
  if not (TabsViewInfo.GetHitInfo(Result, X, Y) or
    ContextsViewInfo.GetHitInfo(Result, X, Y) or
    GroupsDockControlSiteViewInfo.GetHitInfo(Result, X, Y) or
    TabsAreaButtonsViewInfo.GetHitInfo(Result, X, Y) or
    ApplicationButtonViewInfo.GetHitInfo(Result, X, Y))
  then
    ZeroMemory(@Result, SizeOf(Result));
end;
...
begin
  ...
  begin
    ...
    if ApplicationButtonViewInfo.IsVisible then
      ApplicationButtonViewInfo.Paint(ACanvas);
  end;
end;
...
var
  F: TCustomForm;
begin
  F := GetParentForm(Ribbon {$IFDEF DELPHI8}, False{$ENDIF});
  if F is TForm then
  begin
    if F.HandleAllocated and (F.WindowState = wsMinimized) and
      (GetWindowLong(F.Handle, GWL_STYLE) and WS_CHILD = WS_CHILD) then
    begin
      Windows.GetWindowRect(F.Handle, Result);
...
begin
  ...
  if Ribbon.Controller.IsApplicationMenuPopupFrameMode then
    Result := Ribbon.Parent.ClientHeight;
...
begin
  ...
  begin
    ...
    if Assigned(QuickAccessToolbar.Toolbar.Control) then
    begin
      QuickAccessToolbar.Toolbar.Control.Enabled :=
        not Ribbon.Controller.IsApplicationMenuPopupFrameMode;
    end;
  end;
...
begin
  if ApplicationButtonViewInfo.IsVisible then
    Result := CreateRectRgnIndirect(ApplicationButtonViewInfo.Bounds)
  else
    Result := 0;
end;
  ...
  begin
    if IsQATAtNonClientArea then
      Result.Left := GetQATBounds.Right +
        ColorScheme.GetQuickAccessToolbarRightIndent(IsApplicationButtonNearQAT)
    else
      if ApplicationButtonViewInfo.IsVisible then
...
begin
  Result := ColorScheme.GetQuickAccessToolbarOverrideWidth(
    IsApplicationButtonNearQAT(AIgnoreHidden), UseGlass);
end;
...
begin
  ...
  if IsTabsVisible then
    Dec(Result.Top, Painter.ColorScheme.GetPartOffset(DXBAR_TABSGROUPSOVERLAPHEIGHT));
...
begin
  ...
  try
    ...
    ACanvas.ExcludeClipRect(GetTabsAreaBounds);
...
begin
  ...
  F := GetParentForm(Ribbon);
  Result := (F <> nil) and
    (((F.WindowState = wsMinimized) and IsShowMinimizedOnDesktop(F.Handle)) or
     (F.Width < dxRibbonOwnerMinimalWidth) or (F.Height < dxRibbonOwnerMinimalHeight));
end;
...
function TdxRibbonViewInfo.GetCanDrawDefaultFormIcon: Boolean;
begin
  Result := (Style = rs2010) or not ApplicationButtonViewInfo.IsVisible;
end;
...
begin
  ...
  FCollapsedGroupElementSizeDenominator := Skin.GetContentOffsets(DXBAR_COLLAPSEDTOOLBAR).Top +
    ...
    InternalGetGroupCaptionHeight(DefaultFontHeight) + (dxRibbonGroupCaptionBottomOffset + 1) -
...
begin
  ...
  try
    ...
    if ACanvas.Font.Size < 8 then
      ACanvas.Font.Size := 8;
    Result := InternalGetGroupCaptionHeight(ACanvas.TextHeight(dxMeasurePattern));
  finally
    ACanvas.Free;
  end;
end;
...
type
  ...
  procedure ReduceGroups(AStage: TGroupsReduceStage; AUpToViewLevel: TdxBarItemRealViewLevel);
  var
    AGroupViewInfo: TdxRibbonGroupBarControlViewInfo;
    AReduceResult: Boolean;
    I: Integer;
  begin
    ...
    begin
      ...
      repeat
        ...
        case AStage of
          grsMultiColumnItemControlsColumnCount:
            AReduceResult := AGroupViewInfo.DecreaseMultiColumnItemControlsColumnCount;
          grsMultiColumnItemControlsCollapsing:
            AReduceResult := AGroupViewInfo.CollapseMultiColumnItemControls;
          grsItemControlsViewLevel:
            AReduceResult := AGroupViewInfo.Reduce(AUpToViewLevel);
          grsGroupsCollapsing:
      ...
      until (not AReduceResult or AllGroupsFitIn);
...
begin
  ...
  begin
    F := GetParentForm(Ribbon);
    if (F.Handle <> AWnd) and not dxHasAsParent(AWnd, Ribbon.Handle) then
...
begin
  ...
  Dec(Result.Bottom, Ribbon.ColorScheme.GetPartOffset(DXBAR_TABSGROUPSOVERLAPHEIGHT));
...
begin
  ...
  try
    Ribbon.ColorScheme.DrawTabGroupsArea(DC, ClientRect, False);
  finally
    ReleaseDC(Handle, DC);
  end;
end;
...
begin
  if not cxRectCompare(NCRect, ClientRect) then
  begin
    cxPaintCanvas.BeginPaint(DC);
    try
...
begin
  with GetWindowPoint(APoint) do
    if cxRectPtIn(GroupDesignRect, X, Y) then
    begin
...
begin
  ...
  FKeyTipsBaseLinePositions.RowKeyTipsBaseLinePositions[2] :=
    Ribbon.SkinGetCaptionRect(BarControl.NCRect, DXBAR_TOOLBAR).Top;
...
procedure TdxRibbonTabGroups.Notify(
...
begin
  if Assigned(IMenu) then
    IMenu.ClosePopup;
end;

procedure TdxRibbonApplicationButton.UpdateColorScheme;
begin
  if Assigned(IMenu) then
    IMenu.UpdateColorScheme;
end; 
...
function TdxRibbonApplicationButton.GetIMenu: IdxRibbonApplicationMenu;
begin
  if Menu <> nil then
    Result := Menu as IdxRibbonApplicationMenu
  else
    Result := nil;
end;
...
begin
  if FMenu <> Value then
  begin
    if (Value = nil) or Supports(Value, IdxRibbonApplicationMenu) then
    begin
      if FMenu <> nil then
      begin
        IMenu.ClosePopup;
...
function TdxRibbonFonts.GetApplicationButtonFont: TFont;
begin
  Result := FFont;
  Result.Assign(FFonts[afApplicationButton]);
  Result.Color := GetPartColor(rspApplicationButtonNormal);
end;

function TdxRibbonFonts.GetContextFont: TFont;
const
  ContextFontColorsMap: array[Boolean] of Integer = (rspContextText, rspContextTextOnGlass);
begin
  Result := FFont;
  Result.Assign(FFonts[afTabHeader]);
  Result.Color := GetPartColor(ContextFontColorsMap[Ribbon.ViewInfo.UseGlass]);
  Result.Style := Ribbon.ColorScheme.GetContextFontStyle(Result.Style);
end;
...
begin
  ...
  try
    ...
    PopupEx(P.X, P.Y, 0, AOwnerOffset, False, @AOwnerBounds, True, ARibbon);
...
begin
  inherited DoCloseUp;
  FClosedByEscape := TdxBarSubMenuControlAccess(ItemLinks.BarControl).ClosedByEscape;
end;
...
function TdxBarApplicationMenu.IsPopupFrameMode: Boolean;
begin
  Result := False;
end;
...
begin
  if FRibbonPainter = nil then
    raise EdxRibbonException.Create(cxGetResourceString(@dxSBAR_APPMENUOUTSIDERIBBON));
  inherited Popup(X, Y);
end;
...
begin
  ...
  begin
    ARect := Ribbon.ApplicationButtonViewInfo.Bounds;
...
function TdxRibbonController.IsApplicationMenuPopupFrameMode: Boolean;
begin
  Result := IsApplicationMenuDropped and ApplicationButton.IMenu.IsPopupFrameMode;
end;
...
procedure TdxRibbonController.MouseDown(
...
begin
  ...
  begin
    if not ApplicationButton.IMenu.IsPopupFrameMode then
  ...
  case AHitInfo.HitTest of
    rhtTab:
      ProcessTabOnMouseDown(AHitInfo, Button, Shift);
    rhtApplicationMenu:
  ...
  if Button = mbLeft then
  begin
    TabsAreaButtonsViewInfo.PressedButton := AHitInfo.TabAreaButton;
...
begin
  ...
  TabsAreaButtonsViewInfo.HotButton := nil;
...
begin
  AHitInfo := ViewInfo.GetHitInfo(X, Y);
  ApplicationButtonViewInfo.IsHot := AHitInfo.HitTest = rhtApplicationMenu;
  if NotHandleMouseMove(cxPoint(X, Y)) then Exit;
  TabsAreaButtonsViewInfo.HotButton := AHitInfo.TabAreaButton;
  Ribbon.HighlightedTab := AHitInfo.Tab;
  HotObject := AHitInfo.HitTest;
  HintInfo := AHitInfo;
end;

procedure TdxRibbonController.MouseUp(
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
var
  AHitInfo: TdxRibbonHitInfo;
begin
  ...
  begin
    ReleaseCapture;
    AHitInfo := ViewInfo.GetHitInfo(X, Y);
    if AHitInfo.TabAreaButton = TabsAreaButtonsViewInfo.PressedButton then
    begin
      if Assigned(AHitInfo.TabAreaButton) and AHitInfo.TabAreaButton.Enabled then
        AHitInfo.TabAreaButton.Click;
    end;
    TabsAreaButtonsViewInfo.PressedButton := nil;
...
function TdxRibbonController.DoHint(var ANeedDeactivate: Boolean;
...
begin
  Result := not Ribbon.IsDesigning and Ribbon.MinimizeOnTabDblClick and
    (not Ribbon.ShowTabGroups or (not FSkipDblClick and AHitInfo.Tab.Active));
end;
...
begin
  if Ribbon.IsBarManagerValid and not Ribbon.IsDesigning then
    Result := (FScrollKind <> rhtNone) or not (IsFormActive(Ribbon.BarManager.ParentForm) or
      IsFormActive(Ribbon.FTabGroupsPopupWindow)) or dxBarHasPopupWindowAbove(nil, False)
  else
    Result := True;
end;
...
begin
  ...
  if AHitInfo.HitTest = rhtContext then
  begin
...
procedure TdxRibbonController.ProcessTabOnMouseDown(
  const AHitInfo: TdxRibbonHitInfo; AButton: TMouseButton; AShift: TShiftState);
var
  APrevActiveTab: TdxRibbonTab;
begin
  CloseApplicationMenu;
  APrevActiveTab := Ribbon.ActiveTab;
  if (AButton = mbLeft) and (ssDouble in AShift) and CanSwitchMinimizedOnDblClick(AHitInfo) then
    Ribbon.ShowTabGroups := not Ribbon.ShowTabGroups
  else
    ProcessTabClick(AHitInfo.Tab, AButton, AShift);
...
function TdxRibbonController.GetTabsAreaButtonsViewInfo: TdxRibbonTabsAreaButtonsViewInfo;
begin
  Result := ViewInfo.TabsAreaButtonsViewInfo;
end;
...
begin
  ViewInfo.TabsAreaButtonsViewInfo.Invalidate;
end;
...
begin
  ...
  if RibbonViewInfo.IsTabGroupsVisible and (FSite.Ribbon.ActiveTab <> nil) then
  begin
    FTabGroupsScrollButtons := FSite.Ribbon.ActiveTab.DockControl.ViewInfo.ScrollButtons;
    R := GetControlRect(FSite);
    AScrollButtonWidth := RibbonViewInfo.GetScrollButtonWidth;
...
var
  ASavedOrg, ANewOrg: TPoint;
  ATab: TdxRibbonTab;
begin
  ASavedOrg := ACanvas.WindowOrg;
  try
    ANewOrg := ASavedOrg;
    MapWindowPoint(FSite.Handle, FSite.Ribbon.Handle, ANewOrg);
    ACanvas.WindowOrg := ANewOrg;
    RibbonViewInfo.ApplicationButtonViewInfo.Paint(ACanvas);
...
procedure TdxRibbonGroupsDockControlSiteViewInfo.DrawScrollButton(
  ACanvas: TcxCanvas; AButton: TdxRibbonScrollButton);
begin
  if not FTabGroupsScrollFadingHelpers[AButton].IsEmpty then
    FTabGroupsScrollFadingHelpers[AButton].DrawImage(
      ACanvas.Handle, FTabGroupsScrollButtonBounds[AButton])
  else
    RibbonPainter.DrawGroupsScrollButton(ACanvas,
  ...
  RibbonPainter.DrawGroupsScrollButtonArrow(ACanvas,
    FTabGroupsScrollButtonBounds[AButton], AButton = rsbLeft);
...
begin
  RibbonPainter.DrawGroupsArea(ACanvas, GetControlRect(FSite));
  DrawRibbonParts(ACanvas);
  if rsbLeft in TabGroupsScrollButtons then
    DrawScrollButton(ACanvas, rsbLeft);
  if rsbRight in TabGroupsScrollButtons then
    DrawScrollButton(ACanvas, rsbRight);
end;

function TdxRibbonGroupsDockControlSiteViewInfo.GetRibbonPainter: TdxRibbonPainter;
begin
  Result := FSite.Ribbon.Painter;
end;
  ...
  begin
    ...
    try
      if DoApplicationMenuClick or (ApplicationButton.IMenu = nil) then
        ...
        if ApplicationButton.IMenu.CanShowPopup(Self) then
        begin
          BeforeApplicationMenuPopup;
          try
            Result := ApplicationButton.IMenu.Popup(Self, AClosedByEscape);
            if Result and AClosedByEscape and BarNavigationController.NavigationMode then
              ApplicationButtonIAccessibilityHelper.Select(False);
          finally
...
begin
  ...
  if Assigned(Fader) and not (IsDesigning or LockedCancelHint) then
    Fader.Clear;
...
function TdxCustomRibbon.GetIsApplicationMenuDropped: Boolean;
begin
  Result := Controller.IsApplicationMenuDropped;
end;
...
begin
  CheckHide;
  if Controller.IsApplicationMenuPopupFrameMode then
    UpdateHeight;
end;
...
begin
  case APart of
    rbvpBackstageViewTopLine:
      ColorScheme.DrawBackstageViewTopLine(DC, ARect);
    rbvpBackstageView:
...
procedure TdxCustomRibbon.AdjustClientRect(var Rect: TRect);
begin
  Rect.Top := ViewInfo.TabsBounds.Bottom;
end;

procedure TdxCustomRibbon.AfterApplicationMenuPopup;
begin
  Exclude(FInternalState, risAppMenuActive);
  if ApplicationButton.IMenu.IsPopupFrameMode then
    Changed;
end;
  ...
  begin
    ...
    begin
      if IsCompositionEnabled then
        RibbonForm.SetRedraw(False);
      RibbonForm.DisableAlign;
      try
        inherited VisibleChanged;
        RibbonForm.ResetWindowRegion;
        RibbonForm.UpdateBorders;
        Changed;
      finally
        RibbonForm.EnableAlign;
        if IsCompositionEnabled then
          RibbonForm.SetRedraw(True)
        else
          WinControlFullInvalidate(RibbonForm, True);
      end;
    end
    else
      inherited VisibleChanged;
    RibbonForm.UpdateSkins;
  end
  else
    inherited VisibleChanged;
end;
...
begin
  ...
  begin
    ...
    begin
      ATop := Bottom - AIntf.GetHeight - ColorScheme.GetWindowBordersWidth(True).Bottom;
      ABottom := Bottom;
      AIsRectangular := IsRectangularFormBottom(AData);
      if not AIsRectangular and (Style = rs2007) then Dec(ABottom);
      ...
      ColorScheme.DrawFormStatusBarPart(ACanvas.Handle, ALeftStatusBarBounds,
        True, AData.Active, AIntf.GetIsRaised(True), AIsRectangular);
      ...
      ColorScheme.DrawFormStatusBarPart(ACanvas.Handle, ARightStatusBarBounds,
        False, AData.Active, AIntf.GetIsRaised(False), AIsRectangular);
...
begin
  ...
  try
    ...
    ApplicationButtonViewInfo.Paint(cxPaintCanvas);
    MoveWindowOrg(cxPaintCanvas.Handle, -AOffset.X, -AOffset.Y);
  finally
    cxPaintCanvas.EndPaint;
  end;
...
begin
  ...
  TryAddToNavigationList(ApplicationButtonIAccessibilityHelper);
end;
...
begin
  Result := FColorScheme.DisplayName;
end;
...
begin
  for I := 0 to SkinManager.SkinCount - 1 do
    ...
    begin
      ColorScheme := TdxCustomRibbonSkin(SkinManager[I]);
      Break;
    end;
end;
...
begin
  ColorScheme := GetColorScheme(Value, Style);
end;
...
begin
  ColorScheme := GetColorScheme(ColorSchemeName, AValue);
end;
...
begin
  ...
  try
    ApplicationButton.UpdateColorScheme;
    Fonts.UpdateFonts;
    RecalculateBars;
    Changed;
  finally
...
begin
  inherited Create(TdxRibbonQuickAccessGroupButton(AGroupButtonControl.Item).Toolbar.BarManager);
  InitializeForPopup(TdxBarControl(AGroupButtonControl.Parent),
...
var
  AChild: IdxBarAccessibilityHelper;
begin
  Result := nil;
  AChild := InternalGetChild(AIndex);
  if AChild <> nil then
    Result := AChild.GetHelper;
end;

function TdxRibbonAccessibilityHelper.GetChildCount: Integer;
begin
  Result := 2 + Ribbon.ViewInfo.TabsAreaButtonsViewInfo.Count;
...
begin
  Result := InternalGetChildIndex(dxBar.GetAccessibilityHelper(AChild));
end;
...
function TdxRibbonAccessibilityHelper.InternalGetChild(AIndex: Integer): IdxBarAccessibilityHelper;
begin
  if AIndex = 0 then
    Result := Ribbon.TabsIAccessibilityHelper
  else
    if (AIndex >= 1) and (AIndex <= TabsAreaButtonsViewInfo.Count) then
      Result := TabsAreaButtonsViewInfo[AIndex - 1].AccessibilityHelper
    else
      case AIndex - TabsAreaButtonsViewInfo.Count - 1 of
        0: Result := Ribbon.ApplicationButtonIAccessibilityHelper;
        1: Result := Ribbon.QATIAccessibilityHelper;
        else
          Result := nil;
      end;
end;

function TdxRibbonAccessibilityHelper.InternalGetChildIndex(AChild: IdxBarAccessibilityHelper): Integer;
var
  I: Integer;
begin
  Result := -1;
  if AChild = Ribbon.TabsIAccessibilityHelper then
    Result := 0
  else
  begin
    for I := 0 to TabsAreaButtonsViewInfo.Count - 1 do
      if TabsAreaButtonsViewInfo[I].AccessibilityHelper = AChild then
      begin
        Result := I + 1;
        Exit;
      end;

    if AChild = Ribbon.ApplicationButtonIAccessibilityHelper then
      Result := 1 + TabsAreaButtonsViewInfo.Count;
    if (Ribbon.QATIAccessibilityHelper <> nil) and (AChild = Ribbon.QATIAccessibilityHelper) then
      Result := 2 + TabsAreaButtonsViewInfo.Count
  end;
end;
...
function TdxRibbonAccessibilityHelper.GetTabsAreaButtonsViewInfo: TdxRibbonTabsAreaButtonsViewInfo;
begin
...
begin
  BarNavigationController.UnselectAssignedSelectedObject;
  if Assigned(Ribbon.ApplicationButton.IMenu) then
