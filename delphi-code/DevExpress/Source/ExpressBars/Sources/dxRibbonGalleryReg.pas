...
var
  AGalleryItem: TdxRibbonGalleryItemAccess;
begin
  AGalleryItem := TdxRibbonGalleryItemAccess(GetComponent(0) as TdxRibbonGalleryItem);
  if not AGalleryItem.UnderDesign then
  begin
    AGalleryItem.UnderDesign := True;
...
begin
  ...
  HideClassProperties(TdxRibbonGalleryOptions, ['CanCollapse', 'Collapsed',
    ...
    'EqualItemSizeInAllGroups', 'RowCount', 'SubMenuResizing']);
