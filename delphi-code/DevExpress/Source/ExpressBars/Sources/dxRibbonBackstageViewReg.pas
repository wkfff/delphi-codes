...
{$ELSE}
  DsgnIntf,
{$ENDIF}
  Windows, Classes, SysUtils, Messages, Controls, Graphics, Math, Forms,
  StdCtrls, cxGraphics, cxGeometry, cxControls, cxClasses, dxBar, dxRibbon,
  dxRibbonSkins, dxRibbonBackstageView, dxCoreReg, dxBarReg, cxDesignWindows,
...
procedure Register;
begin
  RegisterComponents('ExpressBars', [TdxRibbonBackstageView]);
