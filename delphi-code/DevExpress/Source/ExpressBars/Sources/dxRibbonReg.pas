...
{$ENDIF}
  ...
  dxRibbonMiniToolbar, dxBarPopupMenuEd;
...
type
  ...
  protected
    function CanAddSkin(ASkin: TdxCustomBarSkin): Boolean; virtual;
  public
...
{$ENDIF}
  RegisterComponents('ExpressBars', [TdxRibbon, TdxRibbonPopupMenu, TdxBarApplicationMenu, TdxRibbonStatusBar, TdxRibbonMiniToolbar]);
  ...
  RegisterPropertyEditor(TypeInfo(TdxBarItemLinks), TdxRibbonMiniToolbar, 'ItemLinks', TdxBarItemLinksPropertyEditor);
...
function TdxRibbonColorSchemeNameProperty.CanAddSkin(ASkin: TdxCustomBarSkin): Boolean;
begin
  Result := ASkin is TdxCustomRibbonSkin;
end;
