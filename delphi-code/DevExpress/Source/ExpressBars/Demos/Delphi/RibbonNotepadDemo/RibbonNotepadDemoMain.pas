...
{$IFDEF EXPRESSSKINS}
  dxSkinChooserGallery, dxSkinsdxRibbonPainter,
{$ENDIF}
...
{$IFDEF EXPRESSSKINS}
procedure TRibbonDemoMainForm.SkinChanged(Sender: TObject; const ASkinName: String);
begin
...
begin
  ...
  FChooser := TdxSkinChooserGalleryItem.Create(BarManager);
