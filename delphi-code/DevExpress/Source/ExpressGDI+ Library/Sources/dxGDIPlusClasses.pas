...
type
  ...
  public
    ...
    procedure StretchDraw(DC: HDC; const ADest: TRect; AAlpha: Byte = 255); overload; virtual;
    procedure StretchDraw(DC: HDC; const ADest, ASource: TRect; AAlpha: Byte = 255); overload; virtual;
    procedure StretchDrawEx(Graphics: GpGraphics; const ADest, ASource: TRect; AAlpha: Byte = 255); virtual;
...
procedure TdxPNGImage.LoadFromResource(
...
procedure TdxPNGImage.StretchDraw(DC: HDC; const ADest: TRect; AAlpha: Byte = 255);
begin
  StretchDraw(DC, ADest, ClientRect, AAlpha);
end;

procedure TdxPNGImage.StretchDraw(DC: HDC; const ADest, ASource: TRect; AAlpha: Byte = 255);
var
  AGraphics: TdxGPGraphics;
begin
  if Handle <> nil then
  begin
    ...
    StretchDrawEx(AGraphics.Handle, ADest, ASource, AAlpha);
    dxGpEndPaint(AGraphics);
  end;
end;

procedure TdxPNGImage.StretchDrawEx(Graphics: GpGraphics;
  const ADest, ASource: TRect; AAlpha: Byte = 255);
begin
  if Handle <> nil then
    Handle.DrawEx(Graphics, ADest, ASource, AAlpha);
end;
