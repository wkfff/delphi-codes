...
uses
  ...
  Menus, StdCtrls, ExtCtrls, ComCtrls, Buttons, ImgList, dxPSfmLnkAdd, dxPSCore,
  dxPSDsgProxies, dxPSGlbl, cxLookAndFeelPainters, cxButtons, cxEdit, cxGroupBox,
  cxControls, cxContainer, cxListBox, cxGraphics, dxCore,
 {$IFDEF DELPHI6}
   DesignIntf, DesignWindows, cxLookAndFeels
 {$ELSE}
   DsgnIntf, DsgnWnds, LibIntf, cxLookAndFeels
 {$ENDIF}
  ;
