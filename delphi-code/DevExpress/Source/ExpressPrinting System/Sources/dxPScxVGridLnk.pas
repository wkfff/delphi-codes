...
uses
  ...
  Menus, ImgList, cxClasses, cxControls, cxGraphics, cxLookAndFeels, cxStyles, 
...
begin
  ScreenCanvas.Font := AFont;
  Result := 2 + ScreenCanvas.TextSize('Wg').cy + 2;
end;
...
begin
  ScreenCanvas.Font := AFont;
  Result := 3 + ScreenCanvas.TextSize(AText).cx + 3;
end;
