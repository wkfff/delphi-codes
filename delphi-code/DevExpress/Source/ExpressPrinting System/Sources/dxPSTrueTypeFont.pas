...
begin
  ...
  FPrepSection := TdxPSTTFBinarySection.CreateEx(Self, GetSectionTag('prep'));
  FCvtSection := TdxPSTTFBinarySection.CreateEx(Self, GetSectionTag('cvt '));
  FFpgmSection := TdxPSTTFBinarySection.CreateEx(Self, GetSectionTag('fpgm'));
