...
uses
 ...
 {$ENDIF} 
  ...
  dxPSImgs, dxExtCtrls, cxContainer;
...
const
  ...
  begin
    ...
    begin
      ...
      begin
        X := Left + 2;
        Y := Top + (Bottom - Top - TextHeight(dxMeasurePattern)) div 2;
      end;      
...
function CompareItemsAsIntegers(AItem1, AItem2: Pointer): Integer;
begin
...
begin
  ...
  Height := Max(Canvas.TextHeight(dxMeasurePattern), AHeight) + 2;
end;
