...
uses
  Classes, Controls, Windows, Menus, dxBase, dxPSSngltn, cxGeometry, cxClasses, dxHooks;
...
procedure dxPSPopupManKeyboardHook(ACode, WParam, LParam: Integer; var AHookResult: Integer);
...
procedure dxPSPopupManMouseHook(ACode, WParam, LParam: Integer; var AHookResult: Integer);
