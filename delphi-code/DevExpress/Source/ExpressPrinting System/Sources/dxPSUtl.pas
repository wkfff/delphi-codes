...
uses
  ...
  ComCtrls, Dialogs, CommCtrl, Forms, Menus, ImgList, TypInfo, Registry, cxClasses,
  cxGraphics, dxPSGlbl, dxPrnDev, dxCore, cxTextEdit, cxLabel, cxDropDownEdit,
  cxGeometry, cxButtons, IniFiles, cxLookAndFeels, cxControls;
...
begin
  ...
  MemRect := Rect(0, 0, Size.cX, Size.cY);  
...
begin
  ...
  try
    Bitmap_LoadFromResourceName(ABitmap, AResName);
