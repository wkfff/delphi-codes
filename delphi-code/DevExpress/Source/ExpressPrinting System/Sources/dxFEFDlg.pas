...
uses
  ...
  dxBkgnd, cxLookAndFeelPainters, cxButtons, cxControls, cxContainer, IniFiles,
  cxEdit, cxGroupBox, cxLabel, cxGraphics, cxTextEdit, cxMaskEdit, cxDropDownEdit,
  cxColorComboBox, cxPC, dxExtCtrls, dxPSReportRenderCanvas, cxLookAndFeels;
