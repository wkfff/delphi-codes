...
uses
  ...
  ExtCtrls, ImgList, Menus, Dialogs, ExtDlgs, Contnrs, Types, cxClasses, cxControls,
  cxGraphics, cxGeometry, cxStyles, cxLookAndFeels, cxLookAndFeelPainters, cxEdit,
  cxTextEdit, cxInplaceContainer, cxTL, cxDBTL, cxTLData, cxCustomData, dxExtCtrls,
  dxBase, dxPSSngltn, dxPrnPg, dxPSCore, dxPScxCommon, cxContainer, cxLabel,
  cxCheckBox, cxMaskEdit, cxDropDownEdit, cxButtons, cxPC, cxSpinEdit,
...
begin
  ...
  begin
    ...
    AItem.Data := Integer(AColumnPlace.Column);
...
begin
  ...
  begin
    ...
    ARow.Data := Integer(ABandPlace.Band);
...
begin
  ...
  AIndentsRow.Data := Integer(TcxTreeListIndentsRowAttribute);
...
function TcxTreeListCustomReportLink.GetReportCellDataByColumn(
  ...
  var
    I: Integer;
  begin
    Result := AReportCell.FindDataItemByData(Integer(AColumn), AData);
    if not Result then
    begin
