...
function cxRectProportionalStretch(const R: TRect; W, H: Integer): TRect; {$IFDEF DELPHI9} inline; {$ENDIF}
...
begin
  ...
  H1 := R.Bottom - R.Top;
  if W / H > W1 / H1 then
    Result.Bottom := Result.Top + (W1 * H div W)
  else
    Result.Right := Result.Left + (H1 * W div H);
end;
