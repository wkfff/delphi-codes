...
procedure cxContainerWndProcHook(ACode, WParam, LParam: Integer; var AHookResult: Integer);
...
procedure cxContainerGetMessageHook(ACode, WParam, LParam: Integer; var AHookResult: Integer);
var
  APMsg: PMSG;
  APopupWindow: TcxCustomPopupWindow;
begin
  if (FVisiblePopupWindowList.Count > 0) and (ACode = HC_ACTION) and (WParam = PM_REMOVE) then
  begin
    APMsg := PMSG(LParam);
...
procedure cxContainerMouseHook(ACode, WParam, LParam: Integer; var AHookResult: Integer);
...
begin
  if (FVisiblePopupWindowList.Count > 0) and (ACode = HC_ACTION) then
    case WParam of
