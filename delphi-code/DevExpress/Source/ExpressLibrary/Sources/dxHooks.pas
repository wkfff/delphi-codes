...
uses
  Windows, SysUtils, Classes, Contnrs, Forms, dxCore;

type
  TdxHookType = (htKeyboard, htMouse, htWndProc, htGetMessage);
  TdxHookProc = procedure (ACode, WParam, LParam: Integer; var AHookResult: Integer);
...
type
  ...
  private
    ...
    function ProcessHookProcs(ACode, WParam, LParam: Integer): LRESULT;
  protected
...
function TdxSystemHook.ProcessHookProcs(ACode, WParam, LParam: Integer): LRESULT;
var
  I, AHookResult: Integer;
begin
  AHookResult := 0;
