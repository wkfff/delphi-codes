...
function TcxFormatController.QueryInterface(const IID: TGUID; out Obj): HResult;
begin
...
function TcxFormatController._AddRef: Integer;
begin
  Result := -1;
end;

function TcxFormatController._Release: Integer;
begin
  Result := -1;
end;
