...
type
  ...
  public
    ...
    procedure LoadFromTextFile(AFileName: string); dynamic;
    procedure SaveToTextFile(AFileName: string); dynamic;
    procedure LoadFromBinaryFile(AFileName: string); dynamic;
    procedure SaveToBinaryFile(AFileName: string); dynamic;
...
procedure TdxCustomMemData.SaveToTextFile(AFileName: string);
...
procedure TdxCustomMemData.LoadFromTextFile(AFileName: string);
...
procedure TdxCustomMemData.LoadFromBinaryFile(AFileName: string);
var
...
procedure TdxCustomMemData.SaveToBinaryFile(AFileName: string);
var
