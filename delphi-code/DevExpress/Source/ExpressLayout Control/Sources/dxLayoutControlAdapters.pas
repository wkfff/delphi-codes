...
type
  ...
  protected
    ...
    procedure StartCustomization; override;
...
begin
  ...
  begin
    ...
    if AForm <> nil then
      AForm.Perform(CM_FOCUSCHANGED, 0, Longint(AForm.ActiveControl));
  end;
end;
...
procedure TdxButtonControlAdapter.StartCustomization;
const
  BS_TYPEMASK       = $0F;
  BS_DEFSPLITBUTTON = $0000000D;
  BS_DEFCOMMANDLINK = $0000000F;
begin
  inherited StartCustomization;
