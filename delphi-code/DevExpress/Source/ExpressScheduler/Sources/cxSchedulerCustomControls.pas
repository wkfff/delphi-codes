...
uses
  ...
  dxCore, cxControls, cxGraphics, cxGeometry, cxLookAndFeels, cxLookAndFeelPainters,
  cxFormats, cxSchedulerUtils, cxSchedulerStorage, cxStyles, cxClasses, cxEdit,
  cxDateUtils, cxStorage, cxTextEdit, cxNavigator, cxVariants;
...
type
  ...
  protected
    ...
    function GetScrollBar(AKind: TScrollBarKind): TcxControlScrollBar;
...
begin
  ...
  if View.GetTimeIncrement = 1 then
    Scheduler.ReplaceSelParams(DateOf(AEvent.Start),
      ...
      ((TimeOf(AEvent.Finish) = 0) and (AEvent.Start <> AEvent.Finish))) * View.GetTimeIncrement, AResource)
  else
  begin
