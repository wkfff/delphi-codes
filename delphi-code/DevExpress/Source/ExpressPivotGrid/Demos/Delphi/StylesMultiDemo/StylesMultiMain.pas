...
uses
  ...
  cxEdit, cxStyles, cxPivotGridPredefinedStyles, cxClasses,
  cxStyleSheetEditor, cxPivotGridStyleSheetsPreview, cxGraphics,
  cxCustomData;

type
  TfrmStylesMulti = class(TfrmDemoBaisicMain)
