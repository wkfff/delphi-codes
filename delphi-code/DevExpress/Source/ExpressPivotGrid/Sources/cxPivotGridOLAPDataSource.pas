...
{                   ExpressPivotGrid                                 }
{                                                                    }
{       Copyright (c) 2005-2011 Developer Express Inc.               }
{       ALL RIGHTS RESERVED                                          }
{                                                                    }
  ...
  for AnItemChildIndex := 0 to AMember.ItemCount - 1 do
    ...
    begin
      ...
      if not AreDataFieldsEmpty then
        InitializeCrossCellValues(ARow.GetCellByCrossItem(AColumn), AValues, ANativeValues, not AreDataFieldsEmpty)
      else
        InitializeCrossCellValues(ARow.GetCellByCrossItem(AColumn), Null, Null, not AreDataFieldsEmpty);
    end;
end;
...
begin
  ...
  begin
    ...
    if not AreDataFieldsEmpty then
      InitializeCrossCellValues(AColumn.GetCellByCrossItem(ARow), AValues, ANativeValues, not AreDataFieldsEmpty)
    else
