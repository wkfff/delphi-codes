...
type
  TColumnsMultiEditorsDemoPopupForm = class(TForm)
    ...
    procedure tlPopupHotTrackNode(Sender: TObject; ANode: TcxTreeListNode;
      AShift: TShiftState; var ACursor: TCursor);
    procedure tlPopupClick(Sender: TObject);
    procedure tlPopupStylesGetHotTrackStyle(Sender, AItem: TObject;
...
procedure TColumnsMultiEditorsDemoPopupForm.tlPopupHotTrackNode(
  Sender: TObject; ANode: TcxTreeListNode; AShift: TShiftState;
  var ACursor: TCursor);
begin
