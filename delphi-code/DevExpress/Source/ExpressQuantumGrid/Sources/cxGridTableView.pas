...
type
  ...
  private
    ...
    procedure SetHeaderImageIndex(Value: TImageIndex);
  ...
  published
    ...
    property HeaderHint;
    property HeaderImageIndex: TImageIndex read FHeaderImageIndex write SetHeaderImageIndex default -1;
    property MinWidth;
...
begin
  ...
  try
    ...
    if AValueIndex = -1 then
      Result := AColumn.GetProperties(Self).GetDisplayText(AValue) //TODO:!!!, False, False)
    else
...
begin
  cxDrawImage(Canvas.Handle, ViewInfo.Bounds, ViewInfo.Bounds,
    ViewInfo.Glyph, ViewInfo.Images, ViewInfo.ImageIndex, idmNormal);
end;
...
function TcxGridColumnHeaderGlyphViewInfo.GetImageIndex: TImageIndex;
begin
...
procedure TcxGridColumn.SetHeaderImageIndex(Value: TImageIndex);
begin
