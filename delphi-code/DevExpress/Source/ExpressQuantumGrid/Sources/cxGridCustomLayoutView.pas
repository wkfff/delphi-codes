...
uses
  ...
  cxClasses, cxCustomData, cxLookAndFeelPainters, cxControls, cxGridCustomView, cxGridCustomTableView;
...
var
  ...
  begin
    ...
    if not AIsVisibleCountCalculated then
      if (ARow = 0) or (ATopBound + Records[I].Height <= AContentBounds.Bottom) then
        Inc(RecordsViewInfo.FVisibleCount)
      else
      begin
