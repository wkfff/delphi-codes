...
begin
  ...
  InternalAdd('scxGridDeletingConfirmationCaption', @scxGridDeletingConfirmationCaption);
  ...
  InternalAdd('scxGridChartStackedColumnDiagramDisplayText', @scxGridChartStackedBarDiagramDisplayText);
