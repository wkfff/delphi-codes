...
begin
  Result := 0;
  if ADataSetName = 'tblItems' then
     Result := ItemsFormID;
  if ADataSetName = 'tblProjects' then
     Result := ProjectsFormID;
  if ADataSetName = 'tblUsers' then
     Result := UsersFormID;
  if ADataSetName = 'tblTeams' then
     Result := TeamsFormID;
  if ADataSetName = 'tblDepartments' then
     Result := DepartmentsFormID;
  if ADataSetName = 'tblSchedule' then
