...
begin
  ...
  cvPersons.Styles.Background := CustomDrawCardViewDemoMainDM.stBlueSky;
end;
...
begin
  SetGradientColor(Sender, csGold, CustomDrawCardViewDemoMainDM.stYellowLight);
end;

procedure TCustomDrawCardViewDemoMainForm.miGreyClick(Sender: TObject);
begin
  SetGradientColor(Sender, csGrey, CustomDrawCardViewDemoMainDM.stGreyLight);
end;

procedure TCustomDrawCardViewDemoMainForm.miBlueClick(Sender: TObject);
begin
  SetGradientColor(Sender, csBlue, CustomDrawCardViewDemoMainDM.stBlueSky);
end;
