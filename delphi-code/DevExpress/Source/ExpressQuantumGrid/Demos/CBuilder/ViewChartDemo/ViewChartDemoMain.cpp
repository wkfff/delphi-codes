...
{
  qrSales->Locate("Name", Sender->Categories->VisibleValues[AValueIndex], TLocateOptions());
  tblOrders->Locate("ProductID", qrSales->FieldByName("ID")->AsInteger, TLocateOptions());
