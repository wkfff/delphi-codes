...
{
  if (ADataSetName == "tblItems")
    return ItemsFrameID;
  if (ADataSetName == "tblProjects")
    return ProjectsFrameID;
  if (ADataSetName == "tblUsers")
    return UsersFrameID;
  if (ADataSetName == "tblTeams")
    return TeamsFrameID;
  if (ADataSetName == "tblDepartments")
    return DepartmentsFrameID;
  if (ADataSetName == "tblSchedule")
