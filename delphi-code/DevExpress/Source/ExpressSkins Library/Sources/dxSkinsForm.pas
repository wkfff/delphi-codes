...
type
  ...
  protected
    ...
    function DoSkinForm(AForm: TCustomForm): TdxSkinLookAndFeelPainter; virtual;
    function DoSkinFormEx(AForm: TCustomForm; var ASkinName: string;
      var AUseSkin: Boolean): TdxSkinLookAndFeelPainter; virtual;
...
begin
  Result := FLookAndFeelPainter <> nil;
  if Result then
    ASkinName := FLookAndFeelPainter.LookAndFeelName;
end;
...
function TdxSkinController.DoSkinForm(AForm: TCustomForm): TdxSkinLookAndFeelPainter;
var
  ASkinName: string;
  AUseSkin: Boolean;
begin
...
function TdxSkinController.DoSkinFormEx(AForm: TCustomForm;
  var ASkinName: string; var AUseSkin: Boolean): TdxSkinLookAndFeelPainter;
var
...
begin
  ...
  begin
    ...
    if AUseSkin and (ASkinName <> '') and
      cxLookAndFeelPaintersManager.GetPainter(ASkinName, APainter) and
      (APainter is TdxSkinLookAndFeelPainter)
    then
      Result := TdxSkinLookAndFeelPainter(APainter);
  end;
end;
...
procedure TdxSkinFormNonClientAreaInfo.CalculateCaptionIconsInfo;
  ...
  begin
    ...
    Result := cxRectCenter(Result, cxRectWidth(Result), CalculateCaptionTextHeight);
  end;
...
function TdxSkinCustomControlPainter.GetPainter: TcxCustomLookAndFeelPainter;
begin
...
procedure dxSkinsWndProcHook(ACode, WParam, LParam: Integer; var AHookResult: Integer);
var
  AMsg: PCWPStruct;
begin
