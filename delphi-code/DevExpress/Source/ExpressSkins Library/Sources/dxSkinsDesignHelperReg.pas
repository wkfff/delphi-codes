...
type
  ...
  public
    ...
    procedure Add(AControlClass: TClass; const AUnitName: string);
    procedure Remove(AControlClass: TClass; const AUnitName: string);
...
uses
  dxSkinsDesignHelper, dxSkinsReg, cxLibraryReg;
...
procedure TdxSkinsAdditionalUnitsList.Add(AControlClass: TClass; const AUnitName: string);
var
...
procedure TdxSkinsAdditionalUnitsList.Remove(AControlClass: TClass; const AUnitName: string);
var
  AItem: TdxSkinsAdditionalUnits;
begin
  if Find(AControlClass, AItem) then
  begin
    AItem.RemoveUnit(AUnitName);
