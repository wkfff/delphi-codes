...
type
  ...
  protected
    function GetButtonBorderExtent(APainter: TcxCustomLookAndFeelPainter;
    ...
    function GetMiddleButtonBorderExtent(APainter: TcxCustomLookAndFeelPainter): TRect;
...
begin
  ...
  begin
    ...
    if cxRectPtIn(InfoPanelViewInfo.Bounds, X, Y) then
      NavigatorOwner2.GetNavigatorInfoPanel.DoClick(Button);
  end;
...
begin
  ...
  try
    ...
    if APainter.LookAndFeelStyle = lfsNative then
...
function TcxNavigatorViewInfo.GetButtonBorderExtent(APainter: TcxCustomLookAndFeelPainter;
  AButtonIndex, AButtonCount: Integer): TRect;
begin
...
function TcxNavigatorViewInfo.GetMiddleButtonBorderExtent(
  APainter: TcxCustomLookAndFeelPainter): TRect;
begin
