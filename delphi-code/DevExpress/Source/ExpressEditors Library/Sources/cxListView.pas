...
uses
  ...
  dxCore, dxMessages, cxClasses, cxContainer, cxControls, cxCustomData, cxGraphics,
  cxGeometry, cxLookAndFeels, cxScrollBar, cxExtEditConsts, cxHeader, cxEdit;
...
type
  ...
  TcxCustomListView = class(TcxCustomEditContainer)
  private
...
uses
  Variants, Graphics, Types, Math, cxLookAndFeelPainters;
...
begin
  if UsecxScrollBars and Container.HScrollBarVisible and Container.VScrollBarVisible then
...
procedure TcxCustomInnerListView.LVMGetHeaderItemInfo(var Message: TDXMHeaderItemInfo);
