...
uses
  Windows, Variants, Classes, Controls, Forms, Graphics, SysUtils, cxClasses,
...
uses
  Math, dxCore, cxGeometry, dxOffice11, dxThemeConsts, dxThemeManager, dxUxTheme,
  ...
  with AViewInfo do
    ...
    begin
      ...
      begin
        ...
        ButtonsInfo[I].Data.BackgroundPartiallyTransparent :=
          IsThemeBackgroundPartiallyTransparent(ATheme, ButtonsInfo[I].Data.NativePart, ButtonsInfo[I].Data.NativeState);
      end
    end
    else
      for I := 0 to Length(AViewInfo.ButtonsInfo) - 1 do
      begin
        ...
        ButtonsInfo[I].Data.BackgroundPartiallyTransparent := ButtonsInfo[I].Data.UseSkins;
      end;
end;
...
begin
  ...
  begin
    Painter.DrawEditorButton(ACanvas, AContentRect,
      ...
      EditBtnPositionMap[AButtonInfo.Data.LeftAlignment]);
  end
  else
...
function TcxSpinEditViewInfo.GetPart(const P: TPoint): Integer;
begin
