...
uses
  Windows, Messages, Variants, Classes, Controls, Forms, Graphics, ImgList, Menus,
  StdCtrls, SysUtils,
  dxUxTheme, cxClasses, cxContainer, cxControls, cxDataStorage, cxGraphics, cxLookAndFeels,
  cxEdit, cxTextEdit, cxGroupBox, cxDropDownEdit, cxFilterControlUtils;
  ...
  try
    ...
    begin
      ...
      APainter.DrawRadioButton(ACanvas, AGlyphRect.Left, AGlyphRect.Top,
        ...
        ItemIndex = AButtonViewInfo.ButtonIndex, False, ABackgroundColor, IsDesigning);
    end;
  finally
...
begin
  ...
  begin
    ...
    Data.NativeState := AButtonStateMap[ButtonIndex = TcxCustomRadioGroupViewInfo(AViewInfo).ItemIndex, Data.State];
...
procedure TcxCustomRadioGroupButton.Paint(ADrawOnlyFocusedState: Boolean);
  ...
  function DrawByPainter(APainter: TcxCustomLookAndFeelPainter): Boolean;
  var
    ABitmap: TcxBitmap;
    ARadioButtonSize: TSize;
  begin
