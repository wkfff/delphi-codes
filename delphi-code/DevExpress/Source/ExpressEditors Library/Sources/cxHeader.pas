...
type
  ...
  TDXMHeaderItemInfo = packed record
    Msg: Cardinal;
    Index: Integer;
...
begin
  ...
  SendGetStructMessage(AHeaderHandle, DXM_GETHEADERITEMINFO, AIndex, AHeaderItemInfo);
...
begin
  ...
  AContentHeight := Canvas.TextHeight(dxMeasurePattern);
