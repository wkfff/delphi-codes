...
uses
  ...
  SysUtils, TypInfo, cxCheckBox, cxCheckComboBox, cxCheckGroup,
...
{$ENDIF}  
  ...
  RegisterComponents(cxEditorsLibraryProductPage, [TcxLabel, TcxProgressBar, TcxTrackBar,
    TcxCheckListBox, TcxColorComboBox, TcxFontNameComboBox, TcxCheckComboBox,
    TcxCheckGroup, TcxRichEdit]);
  RegisterComponents(cxEditorsDBLibraryProductPage, [TcxDBLabel, TcxDBProgressBar, TcxDBTrackBar,
