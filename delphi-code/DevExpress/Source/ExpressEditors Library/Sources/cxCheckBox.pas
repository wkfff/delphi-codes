...
uses
  ...
  SysUtils, cxClasses, cxContainer, cxControls, cxCustomData, cxDataStorage,
...
//  ACanvas.Brush.Color := AViewInfo.BackgroundColor; // to fix problem with DC color after RestoreDC
  ...
  ACheckTransparent := AIsBackgroundTransparent and
    (AViewInfo.UseSkins or AViewInfo.HasGlyph or
...
begin
  Result := cxShowPrefix;
  Result := Result or cxAlignVCenter or AHorzAlignmentFlags[Properties.InternalAlignment.Horz];
