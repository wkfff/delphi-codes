...
type
  ...
  protected
    ...
    property ApplyStyleToButtons: Boolean read FApplyStyleToButtons
      write FApplyStyleToButtons;
    // Picture
...
uses
  Variants, Math, cxDrawTextUtils, cxEditUtils, cxGeometry, cxVariants, dxCore;
