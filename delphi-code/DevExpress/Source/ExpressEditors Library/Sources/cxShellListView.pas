...
uses
  ...
  cxCustomData, cxScrollBar, cxLookAndFeels, cxLookAndFeelPainters, 
...
type
  ...
  TcxCustomShellListView = class(TcxCustomEditContainer)
  private
...
procedure TcxInnerShellListView.LVMGetHeaderItemInfo(var Message: TDXMHeaderItemInfo);
...
begin
  ...
  if not IsDestroying then
    Result := FInnerListView.AbsolutePIDL;
end;
