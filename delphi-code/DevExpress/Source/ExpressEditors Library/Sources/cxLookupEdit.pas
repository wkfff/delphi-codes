...
uses
  ...
  cxClasses, cxGraphics, cxControls, cxContainer, cxLookAndFeels, cxEdit,
  cxTextEdit, cxDropDownEdit, cxDataUtils, cxCustomData;
...
begin
  ...
  if HasPopupWindow and not EditModeSetting then
    ILookupData.CurrentKey := EditValue;
end;
