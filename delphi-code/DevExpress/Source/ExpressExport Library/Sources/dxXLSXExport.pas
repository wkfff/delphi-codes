...
{       ExpressExport                                               }
{                                                                   }
{       Copyright (c) 2009-2011 Developer Express Inc.              }
{       ALL RIGHTS RESERVED                                         }
{                                                                   }
...
begin
  ...
  AddNode(ANode, sAlignment, [sHorizontal, sVertical, sWrapText], [AAlignToString[AStyle.Style^.AlignText], sTop, IntToStr(Byte(not AStyle.Style^.SingleLine))]);
end;
