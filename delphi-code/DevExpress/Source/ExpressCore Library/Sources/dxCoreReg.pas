...
begin
  Result := dxGetBuildNumberAsString(dxBuildNumber);
end;
...
begin
  ...
  try
    SplashScreenServices.AddPluginBitmap(Format('Developer Express VCL Products %s', [dxGetBuildNumberAsString(dxBuildNumber)]),
      ASplashBitmap);
  finally
