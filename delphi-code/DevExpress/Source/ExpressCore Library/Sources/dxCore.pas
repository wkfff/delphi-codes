...
const
  dxBuildNumber: Cardinal = 20110101;
...
//    property TwoDigitYearCenturyWindow: Word;
  ...
  procedure dxTestCheck(AValue: WordBool; const AMessage: string); {$IFDEF DELPHI9} inline;{$ENDIF}
...
function dxGetBuildNumberAsString(ABuildNumber: Integer): string;
...
function dxGetBuildNumberAsString(ABuildNumber: Integer): string;
var
  AMajor, AMinor, ABuild, AMinorAndBuild: Integer;
begin
  ...
  Result := Format('v%d vol %d.%d', [AMajor, AMinor, ABuild]);
end;
